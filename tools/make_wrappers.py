...
CH = {
 ...
 "ch07-hamiltonian-lgt":     ("Hamiltonian lattice gauge theory", [],
   "Promote the Kogut--Susskind Hamiltonian material (currently in Ch.~4 source) to a full chapter; foundation for Ch.~22."),
 "ch05-lattice-fermions":    ("Lattice fermions", ["fermions.tex", "staggered.tex", "chiral.tex", "exercises.tex"], None),
 "ch06-improvement-continuum": ("Improvement and the continuum limit", [],
 ...
 "ch09-data-analysis":       ("Data analysis for lattice QFT", [],
 ...
 "ch10-ml-methods":          ("Machine learning methods", [],
   "New chapter: flow-based/normalizing-flow sampling, gauge-equivariant networks (L-CNNs), where ML does and does not help."),
 "ch11-thermodynamics":      ("QCD thermodynamics", ["thermo.tex"], None),
 "ch12-spectroscopy":        ("Hadron spectroscopy", ["spectrum.tex"], None),
 "ch14-matrix-elements":     ("Hadronic matrix elements", ["matrix-elements.tex"], None),
 "ch16-finite-volume":       ("Scattering and finite-volume physics", ["interactions.tex"], None),
 "ch17-isospin-qed":         ("Isospin breaking and QED effects", ["isospin-notes.tex"],
   "New chapter: QED$_\\mathrm{L}$ and friends, renormalisation with QED, finite-volume effects, precision applications."),
 "ch13-qcd-parameters":      ("The parameters of QCD: $\\alpha_s$ and the quark masses",
   ["schrodinger-functional.tex", "strong-coupling-notes.tex", "quark-masses.tex"], None),
