...
\includegraphics[max width=\textwidth, center]{fig-notes-042.jpg}
\end{subfigure}
\begin{subfigure}{0.4\textwidth}
\includegraphics[max width=\textwidth, center]{fig-notes-040.jpg}
\end{subfigure}
...
\begin{figure}
\includegraphics[max width=0.8\textwidth]{fig-notes-041.jpg}
