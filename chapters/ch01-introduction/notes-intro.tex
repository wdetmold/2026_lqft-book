...
\begin{itemize}
  ...
  \item LQFT = QFT defined via a spacetime lattice regulator
  \item Unlike in condensed matter physics, the lattice here is a mathematical tool with no physical significance
  \item LQFT provides a different though equally valid way to access QFT than your previous classes in DRQFT (= QFT defined via dimensional regularisation). The differences make some aspects of QFT more difficult to work with but other aspects easier to consider
  \begin{itemize}
  ...
  \begin{itemize}
  \item LQFT techniques applied to QCD(=LQCD) have a central role in particle and nuclear physics phenomenology and are critical to the determination of the parameters of the Standard Model
