...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{fig-notes-085.png}
...
\begin{figure}
    \centering
    \includegraphics[max width=0.5\textwidth]{fig-notes-030.jpg}
...
\begin{figure}
\label{fig:vert_func}
\includegraphics[max width=0.5\textwidth, center]{fig-notes-031.jpg}
