\section*{Exercises}
\problem{
{\it Free fermion propagator\aidx{fermion propagator}}

Construct the free propagator\aidx{scalar field!propagator} for the domain-wall fermion action in infinite volume and compare it to the continuum free propagator.
}
{See Capitani}
...
The eigenvalues of a massless Dirac operator\aidx{Dirac operator} satisfying the Ginsparg-Wilson relation\aidx{Ginsparg-Wilson relation} are of the form  
$$
...
\end{equation}
where $\langle\ldots\rangle_F$ implies the fermionic expectation value. Show that $H$ is determined solely by the numbers of left and right chirality zero modes\aidx{zero modes (of Dirac operator)} of $D$ and write down an expression for $H$. 
}
{1113}

\problem{{\it Three-point correlation functions\aidx{correlation function}\aidx{correlation function!three-point}}

Typically two-point correlation functions\aidx{correlation function!two-point} are used to determine the spectrum of a lattice field theory. Here you shall consider three--point correlation functions

\begin{enumerate}
    \item By inserting the resolution of the identity in terms of eigenstates of the transfer matrix\aidx{transfer matrix}\aidx{transfer operator} (equivalently the Hamiltonian), perform a spectral decomposition of the three-point correlation function
    \begin{equation}
   ...
   \item Show explicitly how the above correlation function is determined in terms of quark propagators\aidx{quark propagator}.
\end{enumerate}
}
{23445 }
